...
class UserSearch(BaseModel):
    ...
    exclude_team_id: str | None = Field(
        default=None, description="Exclude members already in this team"
    )
    exclude_project_id: str | None = Field(
        default=None, description="Exclude members already in this project"
    )
