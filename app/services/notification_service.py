...
from app.model.notification import NotificationStatus, NotificationType
...
class NotificationService:
    ...
    def toggle_bookmark(self, notification_id: str, user_id: str):
        ...
        new_status = (
            ...
            if notification.status == NotificationStatus.BOOKMARKED
            else NotificationStatus.BOOKMARKED
        )
        return self.notification_repository.update_attr(
            notification_id, "status", new_status
        )
    ...
    def unarchive_notification(self, notification_id: str, user_id: str):
        ...
        return self.notification_repository.update_attr(
            notification_id, "status", NotificationStatus.ACTIVE
        )
