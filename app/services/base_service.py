...
class RepositoryProtocol(Protocol):
    def read_by_options(self, schema: Any, eager: bool = False) -> Any: ...

    def read_by_id(self, id: Any, eager: bool = False) -> Any: ...

    def create(self, schema: Any) -> Any: ...

    def update(self, id: Any, schema: Any, eager: bool = False) -> Any: ...

    def update_attr(self, id: Any, attr: str, value: Any, eager: bool = False) -> Any: ...

    def whole_update(self, id: Any, schema: Any, eager: bool = False) -> Any: ...
