...
def get_my_invitations(
    ...
    return ResponseSchema(
        data=invitations, message="Pending invitations fetched successfully"
    )


@router.get("/{invitation_id}", response_model=ResponseSchema[InvitationResponse])
def get_invitation(
    invitation_id: str, service: InvitationService = Depends(get_invitation_service)
):
...
@router.post(
    "/{invitation_id}/accept", response_model=ResponseSchema[InvitationResponse]
)
...
@router.post(
    "/{invitation_id}/decline", response_model=ResponseSchema[InvitationResponse]
)
